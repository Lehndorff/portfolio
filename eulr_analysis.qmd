...
p1<-ggplot()+
  ...
  labs(fill="Number of Observations",size="Total Observations",
       title="Geographic Distribution of NEEA HEMS Data")+
...
Below is a summary table of each end use including 2019 and 2020 average daily usage (between March 15 and September 1 of each year), percentage change and the distribution of daily usage. Results have not been weather normalized.
